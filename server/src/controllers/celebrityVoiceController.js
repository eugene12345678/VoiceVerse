...
exports.getCelebrityVoices = async (req, res) => {
  try {
    // Real celebrity voice IDs from ElevenLabs - Fixed with correct unique voice IDs
    const celebrityVoices = {
      // Popular female celebrity voices available on ElevenLabs
      'aria': { id: 'EXAVITQu4vr4xnSDxMaL', name: 'Aria', gender: 'female', description: 'Warm and expressive female voice' },
      ...
      // Popular male celebrity voices available on ElevenLabs
