...
// @access  Private
router.post('/:id/like', authMiddleware, feedController.likeFeedPost);

// @route   POST /api/feed/:id/save
// @desc    Save a feed post
// @access  Private
router.post('/:id/save', authMiddleware, feedController.saveFeedPost);

// @route   POST /api/feed/:id/share
// @desc    Share a feed post
// @access  Private
router.post('/:id/share', authMiddleware, feedController.shareFeedPost);
...
// @desc    Like a comment
// @access  Private
router.post('/comments/:id/like', authMiddleware, feedController.likeComment);

// @route   GET /api/feed/saved
// @desc    Get saved posts for the current user
// @access  Private
router.get('/saved', authMiddleware, feedController.getSavedPosts);
